export const en = {
  translation: {
    ...
    notifications: {
      ...
      FRIENDSHIP_REQUEST: '{name} wants to be friends',
      FRIENDSHIP_ACCEPTED: 'You and {name} are now friends',
      DOG_OWNERSHIP_ADDED: 'You were added as an owner of "{dogName}"',
      ORGANIZATION_JOIN_REQUEST: '"{name}" requested to join "{organizationName}"',
      ORGANIZATION_JOIN_APPROVED: 'You were approved to join "{organizationName}"',
      ORGANIZATION_ROLE_UPDATED: 'Your role in "{organizationName}" is now {role}',
      USER_ROLE_UPDATED: 'Your account role is now {role}',
      MESSAGE_RECEIVED: 'You received a message from {name}',
