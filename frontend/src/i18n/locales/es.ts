  ...
  translation: {
    ...
    admin: {
      ...
      users: {
        ...
        deleteMessage: "¿Estás seguro de que quieres eliminar permanentemente {{username}}? Esta acción no se puede deshacer.",
        roleChangeTitle: "Confirmar Cambio de Rol",
        roleChangeMessage: "¿Cambiar el rol de {{username}} de {{oldRole}} a {{newRole}}?",
        roleUpdated: "Rol actualizado a {{role}}",
        userDeleted: "Usuario \"{{username}}\" eliminado",
        failedToChangeRole: "Error al cambiar el rol",
        failedToLoadUsers: "Error al cargar usuarios"
      },
      dogs: {
        title: "Perros",
        searchPlaceholder: "Buscar por nombre o raza...",
        addButton: "+ Agregar Perro",
        name: "Nombre",
        breed: "Raza",
        gender: "Género",
        size: "Tamaño",
        ...
        dateOfBirth: "Fecha de Nacimiento",
        description: "Descripción",
        loadingMessage: "Cargando perros...",
        noFound: "No se encontraron perros.",
        addTitle: "Agregar Perro",
        editTitle: "Editar Perro",
        deleteTitle: "Eliminar Perro",
        deleteMessage: "¿Estás seguro de que quieres eliminar {{name}}? Esta acción no se puede deshacer.",
        dogUpdated: "Perro actualizado",
        dogCreated: "Perro creado",
        dogDeleted: "Perro eliminado",
        failedToSaveDog: "Error al guardar el perro",
        failedToLoadDogs: "Error al cargar perros"
      },
      parks: {
        title: "Parques",
        searchPlaceholder: "Buscar por nombre o dirección...",
        addButton: "+ Agregar Parque",
        name: "Nombre",
        address: "Dirección",
        amenities: "Servicios",
        smallDogArea: "Área para Perros Pequeños",
        latitude: "Latitud",
        longitude: "Longitud",
        description: "Descripción",
        separateSmallDogArea: "Área Separada para Perros Pequeños",
        loadingMessage: "Cargando parques...",
        noFound: "No se encontraron parques.",
        addTitle: "Agregar Parque",
        editTitle: "Editar Parque",
        deleteTitle: "Eliminar Parque",
        deleteMessage: "¿Estás seguro de que quieres eliminar {{name}}? Esta acción no se puede deshacer.",
        parkUpdated: "Parque actualizado",
        parkCreated: "Parque creado",
        parkDeleted: "Parque eliminado",
        failedToSavePark: "Error al guardar el parque",
        failedToLoadParks: "Error al cargar parques"
      },
      organizations: {
        title: "Organizaciones",
        searchPlaceholder: "Buscar por nombre...",
        addButton: "+ Agregar Organización",
        name: "Nombre",
        description: "Descripción",
        website: "Sitio Web",
        ...
        noFound: "No se encontraron organizaciones.",
        ...
        failedToSaveOrg: "Error al guardar la organización",
        failedToLoadOrgs: "Error al cargar organizaciones"
      },
      events: {
        title: "Eventos",
        ...
        noFound: "No se encontraron eventos.",
