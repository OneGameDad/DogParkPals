export const es = {
  translation: {
    ...
    notifications: { // don't change the {name} bits, it's part of the code
      ...
      organizationJoinRequest: '"{name}" requested to join "{organizationName}" in Spanish',
      ...
      FRIENDSHIP_REQUEST: '{name} wants to be friends in Spanish',
      FRIENDSHIP_ACCEPTED: 'You and {name} are now friends in Spanish',
      DOG_OWNERSHIP_ADDED: 'You were added as an owner of "{dogName}" in Spanish',
      ORGANIZATION_JOIN_REQUEST: '"{name}" requested to join "{organizationName}" in Spanish',
      ORGANIZATION_JOIN_APPROVED: 'You were approved to join "{organizationName}" in Spanish',
      ORGANIZATION_ROLE_UPDATED: 'Your role in "{organizationName}" is now {role} in Spanish',
      USER_ROLE_UPDATED: 'Your account role is now {role} in Spanish',
      MESSAGE_RECEIVED: 'You received a message from {name} in Spanish',
      EVENT_INVITATION: 'You were invited to an event in Spanish',
      EVENT_CREATED: '{name} created a new event in Spanish',
      EVENT_REMINDER: 'Event reminder in Spanish',
      ACHIEVEMENT_EARNED: 'You earned an achievement in Spanish',
      LEVEL_UP: 'You leveled up in Spanish',
      COMMENT_REPLY: 'Someone replied to your comment in Spanish',
      PARK_REVIEW: 'A new park review was posted in Spanish',
      ORGANIZATION_INVITE: 'You were invited to join an organization in Spanish',
